...
pub(crate) fn growth_3d_validation_report_single(
    ...
    let target_seed_conditionless_lineage =
        target_seed_conditionless_lineage(target_arg, cfg.seed_mode, source_text);
    let target_growth_seed_mode = target_growth_seed(target_arg, cfg.seed_mode);
