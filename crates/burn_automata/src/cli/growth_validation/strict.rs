...
pub(crate) fn growth_3d_strict_checks_report(
    ...
    target_seed_conditionless_lineage: bool,
    target_growth_seed_mode: bool,
    ...
    let checks = [
        ...
        ("target_growth_seed_mode", target_growth_seed_mode),
...
pub(crate) fn growth_3d_strict_score_report(
    ...
    let hard_failures = [
        ...
        checks.target_seed_conditionless_lineage,
        checks.target_growth_seed_mode,
