...
pub(crate) struct MeshTargetTrainingProfile {
    ...
    pub(crate) position_field_target_source: &'static str,
    pub(crate) rollout_field_target_source: &'static str,
    pub(crate) morphogen_baseline_target_source: &'static str,
    pub(crate) morphogen_rollout_target_source: &'static str,
...
pub(crate) fn mesh_target_training_profile(target: MeshTargetArg) -> MeshTargetTrainingProfile {
    match target {
        MeshTargetArg::Torus => MeshTargetTrainingProfile {
            ...
            position_field_target_source: UV_TORUS_POSITION_FIELD_TARGET_SOURCE,
            rollout_field_target_source: UV_TORUS_ROLLOUT_FIELD_TARGET_SOURCE,
            morphogen_baseline_target_source: UV_TORUS_MORPHOGEN_BASELINE_TARGET_SOURCE,
            morphogen_rollout_target_source: UV_TORUS_MORPHOGEN_ROLLOUT_TARGET_SOURCE,
        ...
        MeshTargetArg::Teapot => MeshTargetTrainingProfile {
            ...
            position_field_target_source: TEAPOT_POSITION_FIELD_TARGET_SOURCE,
            rollout_field_target_source: TEAPOT_ROLLOUT_FIELD_TARGET_SOURCE,
            morphogen_baseline_target_source: TEAPOT_MORPHOGEN_BASELINE_TARGET_SOURCE,
            morphogen_rollout_target_source: TEAPOT_MORPHOGEN_ROLLOUT_TARGET_SOURCE,
