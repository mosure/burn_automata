...
use super::{Hyper2dScratchSource, sanitize_slug};
...
pub(in crate::cli::commands::hyper_e2e) struct OmniSvgSourceConfig<'a> {
    pub(in crate::cli::commands::hyper_e2e) dataset: OmniSvgDatasetArg,
    pub(in crate::cli::commands::hyper_e2e) split: &'a str,
    pub(in crate::cli::commands::hyper_e2e) cache_dir: &'a Path,
    pub(in crate::cli::commands::hyper_e2e) offset: usize,
    pub(in crate::cli::commands::hyper_e2e) limit: usize,
    pub(in crate::cli::commands::hyper_e2e) page_size: usize,
    pub(in crate::cli::commands::hyper_e2e) download: bool,
    pub(in crate::cli::commands::hyper_e2e) refresh: bool,
    pub(in crate::cli::commands::hyper_e2e) token_env: &'a str,
}
...
impl OmniSvgCachePaths {
    fn new(cache_dir: &Path, dataset: OmniSvgDatasetArg, split: &str) -> Self {
        let root = cache_dir
...
mod tests {
    ...
    fn cache_only_resolver_reads_manifest_range() {
        ...
        let paths =
            OmniSvgCachePaths::new(&cache_dir, OmniSvgDatasetArg::MmsvgIllustration, "train");
