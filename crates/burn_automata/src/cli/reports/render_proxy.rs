...
pub(crate) struct RenderProxyTrainingHistoryEntry {
    ...
    pub(crate) before_selection_max_render_loss: f32,
    pub(crate) before_selection_score: f32,
    pub(crate) before_selection_density_psnr_db: f32,
    pub(crate) before_selection_min_density_psnr_db: f32,
    ...
    pub(crate) selection_max_render_loss: f32,
    ...
    pub(crate) selection_min_density_psnr_db: f32,
...
pub(crate) struct DirectRolloutObjectiveDiagnostics {
    ...
    pub(crate) scale_budget_rms: f32,
    pub(crate) scale_budget_nonzero_fraction: f32,
