...
pub(super) fn robustness_seed_report_with_surface_normal_coverage(
    ...
    Growth3dRobustnessSeedReport {
        ...
        strict_score: 1.0,
        target_conditionless_lineage: true,
        target_seed_conditionless_lineage: true,
        target_growth_seed_mode: true,
        ...
        torus_angular_joint_coverage_fraction: 1.0,
        torus_angular_tube_coverage_fraction: 1.0,
        torus_angular_tube_gap_fraction: 0.0,
