...
[`figures/`](figures/), and the compiled publication
...
```text
docs/evidence/adaptive/adaptive_continuous_scale_ratio4_2026-07-25.json
docs/evidence/adaptive/adaptive_event_aware_long_horizon_2026-07-25.json
configs/verified/2d/adaptive/evaluation/recurrent_target2d_lizard_continuous_ratio4_smoke_3070_2d_wgpu.toml
docs/papers/adaptive/figures/manifest.json
```
