...
checked-in smoke is:
\begin{verbatim}
configs/verified/2d/adaptive/evaluation/
  recurrent_target2d_lizard_continuous_
  ratio4_smoke_3070_2d_wgpu.toml
\end{verbatim}
The paper's 32-seed summary is
\path{docs/evidence/adaptive/adaptive_continuous_scale_ratio4_2026-07-25.json};
event-aware ablations are in
\path{docs/evidence/adaptive/adaptive_event_aware_long_horizon_2026-07-25.json}.
